...
public class GeneradorRT : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            Instantiate(generadorRT, new Vector3(generador.position.x + 25.98076f, 0, generador.position.z + 45f), new Quaternion(-1, 0, 0, 1));
